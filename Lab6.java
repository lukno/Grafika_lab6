...
public class Lab6 extends GLJPanel implements GLEventListener  {
	...
	public void display(GLAutoDrawable drawable) {    
		...
		Polygon_and_Triangle(gl2,14,5,9);
		gl2.glPopMatrix();
	...
	public void init(GLAutoDrawable drawable) {
		...
		float light[] = {  .0f, 0.5f, 0.0f, 0.0f, 1.0f, 0.7f, 0.6f, 0.6f, 1.0f, .25f*128 };//red plastic
		gl2.glLightfv(GL2.GL_LIGHT1,GL2.GL_AMBIENT ,light,1);
